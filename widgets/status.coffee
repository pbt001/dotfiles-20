...
timeAndDate: (date, time) ->
  ...
  return "<span class='white'><span class='icon'>&nbsp&nbsp;</span>#{date}&nbsp<span class='grey'> | </span><span class='icon'>&nbsp;</span>#{time}</span></span>";
...
getWifiStatus: (status, netName, netIP) ->
  ...
  if status == 'USB 10/100/1000 LAN' or status == 'Apple USB Ethernet Adapter'
    ...
    return "<span class='wifi'>&nbsp&nbsp&nbsp</span><span class='white'>--&nbsp&nbsp&nbsp</span>"
